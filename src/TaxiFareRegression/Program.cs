...
namespace FfthhFeb2024.TaxiFareRegression // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        ...
        private static string baseModelsRelativePath = @"../../../../../trained-models";
        ...
        private static ITransformer TrainAndSaveModel(MLContext mlContext)
        {
            ...
            // This removes 8 of our 10,000 records.
            ...
            // This shows the alterations done by the data processing pipeline to:
            //  1) One Hot Encode the VendorId, RateCode, and PaymentType fields
            //  2) Normalize the numeric values of PassengerCount, TripTime, and TripDistance
            // This also shows how these values are concatenated into a "Features" column for later comparison with a "Label" predicted column.
        ...
        /// <summary>
        /// Loads a trained model and makes a prediction using a well known/labeled data point.
        /// </summary>
        private static void TestSinglePrediction(MLContext mlContext)
        {
            ...
            var taxiTripInput = new TaxiTrip()
            {
                VendorId = "VTS",
                RateCode = "1",
                PassengerCount = 1,
            ...
            // Create/print prediction.
            var resultprediction = predEngine.Predict(taxiTripInput);
